...
class ActionType(StrEnum):
    ...
    APPEAL_GRIEVANCES_EXTRACTED = "APPEAL_GRIEVANCES_EXTRACTED"
    APPEAL_EXTRACTION_FAILED = "APPEAL_EXTRACTION_FAILED"
    APPEAL_RESPONSE_DRAFTED = "APPEAL_RESPONSE_DRAFTED"
    APPEAL_RESOLVED = "APPEAL_RESOLVED"
    # Phase 9
    AUDIT_TRAIL_EXPORTED = "AUDIT_TRAIL_EXPORTED"
    TENDER_ARCHIVED = "TENDER_ARCHIVED"
    CLOSURE_REPORT_GENERATED = "CLOSURE_REPORT_GENERATED"
    # Enterprise
